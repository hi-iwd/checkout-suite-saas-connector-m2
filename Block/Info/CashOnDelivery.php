...
class CashOnDelivery extends \Magento\Payment\Block\Info
{
    ...
    public function __construct(
        ...
        \IWD\CheckoutConnector\Model\Ui\IWDCheckoutOfflinePayCashOnDeliveryConfigProvider $configProvider,
        array $data = []
    )
    {
    ...
    protected $_template = 'IWD_CheckoutConnector::info/cashondelivery.phtml';
